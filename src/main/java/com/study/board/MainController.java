...
public class MainController {
    ...
    @GetMapping("/rc_hof")
    public String hof(Model model)  throws Exception{
    ...
    @GetMapping("/rc_wine")
    public String wine(Model model)  throws Exception{
    ...
    @GetMapping("/profil")
    public String profil(Model model) throws Exception {
        ...
        System.out.println("profil userTbl : " + userTblVO);
        model.addAttribute("profilsession", userTblVO);
