<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://tiles.apache.org/tags-tiles" prefix="tiles" %>
        ...
        <body>
            ...
            <div id="indexBody">
                <div id="meetSpace">
                    <h1 id="meetSpaceTitle">Meeting Board</h1>
                        ...
                        $.ajax({
                            ...
                            success: function (data)    //data :rowCount, bbsList
                            {
                                ...
                                for (let i = 0; i < data.mbbsList.length; i++) {
                                    bstr = '';
                                    bstr += '<tr>';
                                    bstr += '<td>' + data.mbbsList[i].rowNum + '</td>';
                        ...
                        $.ajax
                            ({
                                ...
                                success: function (data)    //data :rowCount, bbsList
                                {
                                    ...
                                    for (let i = 0; i < data.mbbsSearchList.length; i++) {
                                        bstr = '';
                                        bstr += '<tr>';
                                        bstr += '<td>' + data.mbbsSearchList[i].seq + '</td>';
                                        bstr += '<td><a href=\"/mbbs/content?userId=' + data.mbbsSearchList[i].userId + '&seq=' + data.mbbsSearchList[i].seq + '\">' + data.mbbsSearchList[i].title + '</a></td>';
                                        bstr += '<td>' + data.mbbsSearchList[i].userId + '</td>';
                                        bstr += '<td>' + data.mbbsSearchList[i].regDate + '</td>';
                                        bstr += '</tr>';
